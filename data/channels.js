...
export const GROUPS = [
  ...
  },
  {
    ...
    genre: 'kids',
    channels: [
      { id: 'cbeebies',        name: 'CBeebies',        color: '#f59f00' },
      { id: 'cbbc',            name: 'CBBC',            color: '#00b894' },
      { id: 'disney-junior',   name: 'Disney Junior',   color: '#e84393' },
      { id: 'disney-channel',  name: 'Disney Channel',  color: '#2d3fe0' },
      { id: 'nick-jr',         name: 'Nick Jr',         color: '#ff7b00' },
      { id: 'nickelodeon',     name: 'Nickelodeon',     color: '#ff6a00' },
      { id: 'cartoon-network', name: 'Cartoon Network', color: '#111111' },
  ...
  },
  {
    ...
    channels: [
      ...
      { id: 'discovery-hd', name: 'Discovery HD',        color: '#0072ce' },
