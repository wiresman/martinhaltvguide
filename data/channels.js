...
export const GROUPS = [
  {
    ...
    channels: [
      ...
      { id: 'five-hd',     name: '5 HD',        color: '#7b2ff7' },
  ...
  },
  {
    ...
    channels: [
      ...
      { id: 'disney-junior',   name: 'Disney Junior',   color: '#e84393', epgId: 'DisneyJunior.uk' },
      { id: 'disney-channel',  name: 'Disney Channel',  color: '#2d3fe0', epgId: 'DisneyChannel.uk' },
      ...
      { id: 'baby-tv',         name: 'BabyTV',          color: '#ff5ca8', epgId: 'BabyTV.uk' },
    ],
  },
  {
    title: 'News / Factual',
    genre: 'factual',
    channels: [
      { id: 'cnn',          name: 'CNN',                 color: '#cc0000', epgId: 'CNN.uk' },
      { id: 'al-jazeera',   name: 'Al Jazeera',          color: '#fdb913', epgId: 'AlJazeera.uk' },
      { id: 'cnbc',         name: 'CNBC',                color: '#005594', epgId: 'CNBC.uk' },
      { id: 'bloomberg',    name: 'Bloomberg Television', color: '#1a1a2e', epgId: 'Bloomberg.uk' },
      { id: 'discovery-hd', name: 'Discovery HD',        color: '#0072ce', epgId: 'Discovery.uk' },
      { id: 'natgeo-hd',    name: 'National Geographic HD', color: '#ffcc00', epgId: 'NationalGeographic.uk' },
      { id: 'natgeo-wild',  name: 'Nat Geo Wild HD',     color: '#1e824c', epgId: 'NatGeoWild.uk' },
      { id: 'travel-hd',    name: 'Travel Channel HD',   color: '#00a3a3', epgId: 'TravelChannel.uk' },
